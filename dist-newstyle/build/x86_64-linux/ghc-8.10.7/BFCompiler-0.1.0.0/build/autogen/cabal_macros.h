...
/* package Useful-0.0.6 */
#ifndef VERSION_Useful
#define VERSION_Useful "0.0.6"
#endif /* VERSION_Useful */
#ifndef MIN_VERSION_Useful
#define MIN_VERSION_Useful(major1,major2,minor) (\
  (major1) <  0 || \
  (major1) == 0 && (major2) <  0 || \
  (major1) == 0 && (major2) == 0 && (minor) <= 6)
#endif /* MIN_VERSION_Useful */
...
#define CURRENT_PACKAGE_KEY "BFCompiler-0.1.0.0-inplace"
#endif /* CURRENT_packageKey */
#ifndef CURRENT_COMPONENT_ID
#define CURRENT_COMPONENT_ID "BFCompiler-0.1.0.0-inplace"
